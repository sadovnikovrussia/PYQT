...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setMinimumSize(QSize(210, 50))  # Устанавливаем размеры
        ...
        self.pushbutton = QPushButton('Нажать')
        ...
        grid_layout.addItem(QSpacerItem(10, 0, QSizePolicy.Expanding, QSizePolicy.Expanding), 3, 0)
